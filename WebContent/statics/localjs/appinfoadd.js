$(function(){  
	...
	$.ajax({
		type:"GET",//请求类型
		url:"/Appsys/dev/categorylevellist1",//请求的url
		data:{pid:null},//请求参数
		dataType:"json",//ajax接口（请求url）返回的数据类型
		success:function(data){//data：返回数据（json对象）
			$("#categoryLevel1").html("");
	...
	$("#categoryLevel1").change(function(){
		...
		if(categoryLevel1 != '' && categoryLevel1 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/Appsys/dev/categorylevellist2",//请求的url
	...
	$("#categoryLevel2").change(function(){
		...
		if(categoryLevel2 != '' && categoryLevel2 != null){
			$.ajax({
				type:"GET",//请求类型
				url:"/Appsys/dev/categorylevellist3",//请求的url
	...
	$("#back").on("click",function(){
		window.location.href = "/Appsys/dev/list";
	});
	...
	$("#APKName").bind("blur",function(){
		...
		$.ajax({
			type:"GET",//请求类型
			url:"/Appsys/dev/apkexist",//请求的url
